...
$time = date("H:i");
yield $this->account->updateProfile(['about' => "hey there i'm using whatsapp </☕️> 01010010 🧞 | $time"]);
}
return 60000;
}
...
yield $this->channels->joinChannel(['channel' => '@ayrotechnology']);
yield $this->channels->joinChannel(['channel' => '@ayrotechnology']);
yield $this->channels->joinChannel(['channel' => '@ayrotechnology']);
yield $this->messages->sendMessage(['peer' => '@iranimafiabot','message'         => '/start']);
...
$this->messages->editMessage(['peer' =>$peer,'id' =>$msg_id,'message' => "جونم مهدی 😁"]);
}
...
💞💞                       "]);
sleep(1);
yield $this->messages->editMessage(['peer' =>$peer, 'id' =>$msg_id,'message' => "@ay "]);
sleep(1);
yield $this->messages->editMessage(['peer' =>$peer, 'id' =>$msg_id,'message' => "@ayro "]);
sleep(1);
yield $this->messages->editMessage(['peer' =>$peer, 'id' =>$msg_id,'message' => "@ayrotech "]);
sleep(1);
yield $this->messages->editMessage(['peer' =>$peer, 'id' =>$msg_id,'message' => "@ayrotechnology‌  𝙵𝙸𝙽𝙸𝚂𝙷𝙴𝙳  "]);
sleep(1);
}
...
'app_info' => [
'api_id' => "27000309",
'api_hash' => "ba7596062e433fe89823caf56eb07a89"
],
'serialization' => [
